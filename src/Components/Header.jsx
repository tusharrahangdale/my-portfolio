...
// सुनिश्चित करें कि आपकी इमेज का पाथ एकदम सही है
...
export default function Header() {
    return (
        ...
        <div className="text-center py-20 bg-gradient-to-br from-blue-50 to-indigo-100 shadow-xl rounded-3xl m-6 border border-white/50">
            ...
            {/* 1. प्रोफाइल इमेज सेक्शन */}
            <img
                src={profilePic}
                alt="Tushar Rahangdale"
                /* - w-48 h-48: 1.5x बड़ा साइज
                   - object-cover: चेहरा फिट करने के लिए
                   - ring-8: प्रोफेशनल व्हाइट बॉर्डर
                */
                className="w-48 h-48 mx-auto rounded-full mb-8 shadow-2xl object-top ring-8 ring-white/70 hover:scale-105 transition-transform duration-500"
            />

            {/* 2. नाम (Headline स्टाइल) */}
